...
Crawler zbiera štatistiky pomocou záznamov ukladaných do súbory. Skript XXXX \ref{nazov} \todo{nazov scriptu doplnit} ich potom spracuje a zapíše do CSV súboru. 
